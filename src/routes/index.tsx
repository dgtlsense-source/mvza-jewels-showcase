...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MVZA Jewels opens in Ahmedabad on 16 October 2026. Discover antique gold jewellery and request your special opening invitation." },
      { property: "og:title", content: "MVZA Jewels — The unveiling awaits" },
      { property: "og:description", content: "Antique gold jewellery arrives in Ahmedabad on 16 October 2026." },
...
const openingDate = new Date("2026-10-16T10:00:00+05:30");
    ...
    <main className="overflow-hidden bg-background text-foreground">
      <section className="relative flex min-h-[92svh] items-end justify-center overflow-hidden bg-ink px-5 pb-12 pt-8 text-ivory md:min-h-[94vh] md:pb-16">
        ...
        <div className="quiet-rise relative z-10 mx-auto w-full max-w-5xl text-center">
          <p className="mb-5 text-[0.65rem] font-medium uppercase tracking-[0.34em] text-gold-soft md:text-xs">Ahmedabad · 16 October 2026</p>
